...
- ![](res/sprites/stone.png) *Stone* là đối tượng cố định, không thể phá hủy bằng Bomb cũng như không thể đặt Bomb lên được, Bomber và Enemy không thể di chuyển vào đối tượng này
- ![](res/sprites/brick.png) *Brick* là đối tượng được đặt lên các ô Grass, không cho phép đặt Bomb lên nhưng có thể bị phá hủy bởi Bomb được đặt gần đó. Bomber và Enemy thông thường không thể di chuyển vào vị trí Brick khi nó chưa bị phá hủy.
- ![](res/sprites/tree.png) *Tree* là đối tượng cố định, không thể phá hủy bằng Bomb cũng như không thể đặt Bomb lên được, Bomber và Enemy không thể di chuyển vào đối tượng này


- ![](res/sprites/portal.png) *Portal* là đối tượng được giấu phía sau một đối tượng Brick. Khi Brick đó bị phá hủy, Portal sẽ hiện ra và nếu tất cả Enemy đã bị tiêu diệt thì người chơi có thể qua Level khác bằng cách di chuyển vào vị trí của Portal.

Các *Item* cũng được giấu phía sau Brick và chỉ hiện ra khi Brick bị phá hủy. Bomber có thể sử dụng Item bằng cách di chuyển vào vị trí của Item. Thông tin về chức năng của các Item được liệt kê như dưới đây:
- ![](res/sprites/item_speed.png) *SpeedItem* Khi sử dụng Item này, Bomber sẽ được tăng vận tốc di chuyển thêm một giá trị thích hợp
- ![](res/sprites/item_flame.png) *FlameItem* Item này giúp tăng phạm vi ảnh hưởng của Bomb khi nổ (độ dài các Flame lớn hơn)
- ![](res/sprites/item_bomb.png) *BombItem* Thông thường, nếu không có đối tượng Bomb nào đang trong trạng thái kích hoạt, Bomber sẽ được đặt và kích hoạt duy nhất một đối tượng Bomb. Item này giúp tăng số lượng Bomb có thể đặt thêm một.
...
- ![](res/sprites/kondoria_left1.png) *Kondoria* có tốc độ di chuyển chậm nhất, nhưng có thể di chuyển qua ![](res/sprites/brick.png), di chuyển rất thông minh (biết đuổi theo Bomberman và tránh ![](res/sprites/bomb.png))
- ![](res/sprites/minvo_left1.png) *Minvo* có tốc độ di chuyển rất nhanh, di chuyển vô cùng thông minh (biết đuổi theo Bomber)
- ![](res/sprites/ovape_left1.png) *Ovape* có tốc độ di chuyển nhanh và di chuyển "thông minh" hơn so với Kondoria (không thương xuyên đuổi theo Bomber)
- ![](res/sprites/pass_left1.png) *Pass* có tốc độ di chuyển nhanh nhất và di chuyển thông minh nhất (biết đuổi theo Bomber tránh được ![](res/sprites/bomb.png))
- ![](res/sprites/doll_left1.png) *Doll* có tốc độ di chuyển với tốc độ hơi nhanh và di chuyển "thông minh" hơn so với Balloom
...
- Ngoài ra còn có chế độ chơi solo dành cho hai người
